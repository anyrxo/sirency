...
const mainPages = ['index.html', 'blog.html', 'privacy-policy.html', 'terms-and-conditions.html'];

let added = 0;

console.log('🔧 Adding scroll arrow to main pages (BOTTOM RIGHT position)...\n');
...
mainPages.forEach(filename => {
  ...
  // Add scroll arrow styles BOTTOM RIGHT
  const scrollStyles = `
    <style>
        .scroll-to-top {
            position: fixed;
...
console.log(`\n📝 Scroll arrow positioned at BOTTOM RIGHT on all pages`);
console.log('   Desktop: bottom: 100px, right: 80px');
console.log('   Mobile: bottom: 80px, right: 20px');
